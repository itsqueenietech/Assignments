...
let phNum:string = "123-456-7890";
console.log(`Person's phone number: ${phNum}`);

//4. Amount of money in a customer's bank account: 1000.50
let acBalance:number =  1000.50;
console.log(`Amount of money in a customer's bank account : ${acBalance}`);
...
console.log(`Number of employees in a company: ${numOfEmps}`);
